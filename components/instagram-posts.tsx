...
export function InstagramPosts() {
  return (
    <section className="w-full py-12 md:py-24 lg:py-32 bg-[#111122]" id="instagram" aria-labelledby="instagram-title">
      <div className="container px-4 md:px-6">
        <div className="flex flex-col items-center justify-center space-y-4 text-center">
          <div className="space-y-2">
            <h2 id="instagram-title" className="text-3xl font-bold tracking-tighter text-white md:text-4xl/tight">
